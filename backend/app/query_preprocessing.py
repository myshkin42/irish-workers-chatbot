...
ABBREVIATION_EXPANSIONS: List[Tuple[re.Pattern, str, str]] = [
    ...
    (re.compile(r'\bpaye\b', re.IGNORECASE), 'paye pay as you earn income tax payslip deduction', 'paye'),
    (re.compile(r'\bprsi\b', re.IGNORECASE), 'prsi pay related social insurance payslip deduction', 'prsi'),
    (re.compile(r'\busc\b', re.IGNORECASE), 'usc universal social charge payslip deduction', 'usc'),
